...
Original Gmaes (referred to from he reon in as the "Company") ,was established vith the expectation of rapid expansion in the independent game development     industry. The Company solicits financial backing in order to be able to introduce its new products (described below).    
    
Bussiness Description:   
    
Original Games was formed on 10/06/2020 by Jason Teeuewissen.    
An Animation Honors graduate with a Masters in Creative Application Development (in-progress) Also a Freelance game design studio owner and Professional AnimationTechnologist and Part-time Instructor.    
